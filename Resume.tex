...
% \tb \textbf{deterministic} NI cRIO Linux controller  \textbf{anti-aliasing filters}\\
...
% \dates{\textsl{Ongoing}}
% \begin{position}
% \tb Raspberry PI and intel movidius
% \end{position}
...
􏰚\tb Further developing skills and gaining new exposure to firmware, real-time controls, electronics and machine learning and artificial intelligence\\
