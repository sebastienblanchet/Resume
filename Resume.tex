...
\tb Familiar with PLC/SCADA/HMI systems, embedded microcontroller programming (Texas Instruments, Arduino, x86 Assembler), FPGA, Linux, ANSYS FEA/CFX simulation
%---------------------------------------------------------------------------------------------------------
...
􏰚\tb Further developing skills related to firmware, electronics, machine learning and artificial intelligence\\
