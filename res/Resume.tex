...
\tb \textbf{Protocols:} CAN, LIN, UDS, SPI, I2C, JTAG, UART, USB, RS422, Ethernet, FTP, PCIe\\
\tb \textbf{Integration:} Git Bash, Atlassian (JIRA, Confluence, Stash) GitHub, Jenkins, YAML, SCons, Maven\\
\tb \textbf{Concepts:} embedded discrete control systems, DSP, HIL/SIL, TDD, SCRUM, OOP, DSA, CI, API\\
