...
% \tb Experience real-time software, embedded microcontroller programming
...
\employer{\textbf{\href{https://uwaterloo.ca}University of Waterloo {\logo{uw}}}}
...
% Tesla: Co-op 7
\employer{\textbf{\href{https://www.tesla.com/}Tesla {\logo{tesla}}}}
\location{\textbf{Palo Alto, CA, USA}}
\title{\textsl{Firmware Engineering - Energy Products}}
\dates{\textsl{Sep. 2018 - Present}}
\begin{position}
...
% \tb Developping self-test capability on ECU \\
% \tb Python for automated testing regression frameworks \\
% \tb Implementing power electronics control algorithms for industrial inverter, rectifiers \\
% \tb layered software architecture \\
% BIOS TI's RTOS kernel, DSP , MCU
% \tb \textbf{\textsl{Technologies: C, Git, Java, Python, Linux, RTOS, Go}} \\
% \tb \textbf{\textsl{Methodologies: Agile, Scrum, Test Driven Development, Embdedded Systems, Power Electronics}} \\
\end{position}

% Apple: Co-op 6
\employer{\textbf{\href{https://www.apple.com}Apple {\logo{apple}}}}
...
% Altaeros: Co-op 5
\employer{\textbf{\href{http://www.altaeros.com}Altaeros {\logo{altaeros}}}}
...
% ODI: Co-op 4
\employer{\textbf{\href{https://www.ontariodie.com}Ontario Die International {\logo{odi}}}}
...
% PWC: Co-op 3
\employer{\textbf{\href{http://www.pwc.ca}Pratt \& Whitney Canada {\logo{pwc}}}}
...
% Skyjack: Co-op 2
\employer{\textbf{\href{http://www.skyjack.com}Linamar {\logo{linamar}}}}
