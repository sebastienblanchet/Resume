...
\tb \textbf{Programming:} C, C++, C\#, JavaScript, TypeScript, Python, MATLAB, Ruby, GraphQL\\
...
\employer{\textbf{\href{https://linkedin.com/learning}{LinkedIn Learning}{\logoli}}}
\location{\textbf{Online}}
\title{Various Courses (see \href{\myport}{portfolio}  \faGlobe): \\
\textsl{Vue.js, Node.js, TypeScript, Ruby, GraphQL}
% \textsl{Back-end:} C\#, Node.js, Rails\\
% \textsl{Other:} TypeScript, MySQL, MongoDB
}
\dates{\textsl{Oct. 2019 - Present}}
\begin{position}
\end{position}
