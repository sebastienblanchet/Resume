...
\tb \textbf{Integration:} Git Bash, Atlassian (JIRA, Confluence, Stash) GitHub, Jenkins, SCons, CMock\\
\tb \textbf{Concepts:} embedded discrete and optimal control, PID, DSP, HIL/SIL, TDD, OOP, DSA, CI, API\\
% \tb \textbf{Libraries:} Numpy, Pytest, Tensorflow, OpenCV, OpenCL, \\
\tb \textbf{Other:} Bash, Vim, HTML5, CSS, JSON, XML, \LaTeX, Markdown, MISRA, Assembler, Swift
