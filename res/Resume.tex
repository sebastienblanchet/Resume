...
% ssr pwa spa owasp
\tb \textbf{Programming:} C, C++, C\#, JavaScript, TypeScript, Python, MATLAB, HTML5, Rust, Golang, GraphQL\\
...
\tb \textbf{Other:} Git, Travis-CI, Jenkins, Docker, Atlassian, Bash, Vim, JSON, XML, \LaTeX, Markdown
...
\begin{position}
\tb Developing ECU testing software with modern technologies (Node.js, Vue.js, TypeScript, GraphQL)\\
\tb Contributing to multi-threaded C++,C\#,Rust,Golang server-side applications for CentOS/RHEL Linux\\
\tb Using internal TCP/UDP sockets programming API to communicate with MySQL and MongoDB databases\\
...
\tb Employed a TDD mindset with C unit tests, SIL/HIL simulations, Pytest/Golang regression \\
...
\begin{position}
\tb Developed a hardware-in-the-loop system for validation of power electronic control algorithms in C on ECU\\
