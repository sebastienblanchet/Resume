...
% \tb \textbf{Concepts:} syst\`emes de contr\^ole discr\`ets, PID, DSP, HIL/SIL, TDD, OOP, DSA, CI/CD\\
...
\begin{position}
% \tb Developing EEC communication software with modern web technologies (node.js, Express, Angular/AngularJS)\\
\tb D\'eveloppement de logiciels pour EEC avec technologies web modernes (node.js, Angular, HTML5/CSS3)\\
% \tb Contributing to multi-threaded C++/C\# CentOS/RHEL Linux back-end applications\\
...
% \tb Designing low level embedded C drivers on real-time Linux for high-speed data acquisition and processing
